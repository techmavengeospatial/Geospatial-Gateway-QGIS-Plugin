...
SOURCES = \
	__init__.py \
	TS_Manager.py TS_Manager_dialog.py

PLUGINNAME = TS_Manager

PY_FILES = \
	__init__.py \
	TS_Manager.py TS_Manager_dialog.py

UI_FILES = TS_Manager_dialog_base.ui
...
QGISDIR=C:\Users\ali\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
